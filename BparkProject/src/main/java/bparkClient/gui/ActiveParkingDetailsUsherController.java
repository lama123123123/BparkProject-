...
/**
 * Controller for ActiveParkingDetailsManeger.fxml.
 * Handles active parking details - manager uses.
 */
public class ActiveParkingDetailsUsherController {
    ...
    private void handleBack(ActionEvent event) {
        loadScene("/bparkClient/fxml/UsherMainPage.fxml", backBtn);
    }
